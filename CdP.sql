...
--
-- Client :  localhost
-- Généré le :  Dim 27 Septembre 2015 à 23:29
...
`ID` int(11) NOT NULL,
  ...
  `Themes disciplinaires` varchar(150) NOT NULL
...
INSERT INTO `Atelier` (`ID`, `Titre`, `Type`, `Durée`, `Capacité`, `Themes disciplinaires`) VALUES
